...
Draw point on image.
*/
void drawPoint(size_t D, Range, Point, Color)(Slice!(D, Range) canvas, Point point, Color color, int strokeWidth)
{
    ...
    static if (D == 2)
    {
        ...
        {
            for (int r = cast(int)(point[1] - strokeWidth / 2); r < cast(int)(point[1] + strokeWidth / 2);
                    r++)
            {
                for (int c = cast(int)(point[0] - strokeWidth / 2); c < cast(int)(point[0] + strokeWidth / 2);
                        c++)
                {
...
*/
void drawLine(size_t D, Range, Point, Color)(Slice!(D, Range) canvas, Point startPoint,
        Point endPoint, Color color, int strokeWidth)
{
