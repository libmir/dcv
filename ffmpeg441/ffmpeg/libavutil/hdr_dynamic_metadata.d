 ...
 */
module ffmpeg.libavutil.hdr_dynamic_metadata;
...
struct AVDynamicHDRPlus
{
     ...
     */
    ubyte itu_t_t35_country_code;

    /**
     * Application version in the application defining document in ST-2094
     * suite. The value shall be set to 0.
     */
    ubyte application_version;
     ...
     */
    AVHDRPlusColorTransformParams[3] params;
     ...
     */
    ubyte targeted_system_display_actual_peak_luminance_flag;

    /**
     * The number of rows in the targeted system_display_actual_peak_luminance
     * array. The value shall be in the range of 2 to 25, inclusive.
     */
    ubyte num_rows_targeted_system_display_actual_peak_luminance;
     ...
     */
    ubyte num_cols_targeted_system_display_actual_peak_luminance;
     ...
     * 1/15.
     */
    AVRational[25][25] targeted_system_display_actual_peak_luminance;

    /**
     * This flag shall be equal to 0 in bitstreams conforming to this version of
     * this Specification. The value 1 is reserved for future use.
     */
    ubyte mastering_display_actual_peak_luminance_flag;

    /**
     * The number of rows in the mastering_display_actual_peak_luminance array.
     * The value shall be in the range of 2 to 25, inclusive.
     */
    ubyte num_rows_mastering_display_actual_peak_luminance;

    /**
     * The number of columns in the mastering_display_actual_peak_luminance
     * array. The value shall be in the range of 2 to 25, inclusive.
     */
    ubyte num_cols_mastering_display_actual_peak_luminance;
     ...
     */
    AVRational[25][25] mastering_display_actual_peak_luminance;
}
