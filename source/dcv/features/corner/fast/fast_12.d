...
int* fast12_score(const ubyte* i, int stride, xy* corners, int num_corners, int b)
{	
    ...
    for(n=0; n < num_corners; n++)
        scores[n] = fast12_corner_score(i + corners[n].y*stride + corners[n].x, pixel.ptr, b);

    return scores;
}


xy* fast12_detect(const ubyte* im, int xsize, int ysize, int stride, int b, int* ret_num_corners)
{
    int num_corners=0;
    xy* ret_corners;
    int rsize=512;
